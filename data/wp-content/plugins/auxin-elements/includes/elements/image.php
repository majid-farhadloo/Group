...
function auxin_widget_image_callback( $atts, $shortcode_content = null ){
    ...
    $anchor_class  = auxin_is_true( $lightbox ) && ! $elementor_lightbox ? 'aux-lightbox-btn' : '';
    $frame_classes .= auxin_is_true( $lightbox ) && ! $elementor_lightbox ? ' aux-media-frame aux-lightbox-frame' : '';
