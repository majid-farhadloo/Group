...
/* ---------------------------------------------------------------------------------------------------
   ...
   $options[] = array(
    ...
    $options[] = array(
        'title'       => __( 'Top Header Bar Background Gradient', 'phlox' ),
        'description' => __( 'Specifies the background color of top header bar.', 'phlox' ),
    ...
    $options[] = array(
        'title'       => __( 'Top Header Bar Text Color', 'phlox' ),
        'description' => __( 'Specifies the text color of top header bar.', 'phlox' ),
        'id'          => 'site_top_header_text_color',
        'section'     => 'header-section-topbar',
        'dependency'  => array(
            array(
                 'id'      => 'show_topheader',
        ...
        'transport'      => 'postMessage',
        'selectors'   => array(
            ".aux-top-header, .aux-top-header a" => "color:{{VALUE}} !important;"
        ),
        'default'   => '',
        'type'      => 'color'
    );
    ...
    $options[] = array(
        ...
        'description' => __( 'Use custom size for avatars in comment section.', 'phlox' ),
    ...
    $sections[] = array(
        ...
        'description'  => __( 'Preview Portfolio Page', 'phlox'),
    ...
    $options[] = array(
        'title'       => __( 'Footer Copyright Text Color', 'phlox' ),
        ...
        'style_callback' => function( $value = null ){
            if( ! $value ){
                $value = esc_attr( auxin_get_option( 'footer_copyright_link_color' ) );
            }
            return $value ? ".aux-copyright { color: $value; }" : '';
        },
        'transport' => 'postMessage',
        'default'   => ''
    );
    ...
    $options[] = array(
        'title'       => __( 'Phlox Attribution Link Color', 'phlox' ),
        'id'          => 'footer_attribution_link_color',
        'section'     => 'footer-section-footer',
        'type'        => 'color',
        'dependency'  => array(
            array(
        ...
        'style_callback' => function( $value = null ){
            if( ! $value ){
                $value = esc_attr( auxin_get_option( 'footer_attribution_link_color' ) );
            }
            return $value ? ".aux-site-footer .aux-attribution a { color: $value; }" : '';
        },
        'transport' => 'postMessage',
        'default'   => ''
    );
    ...
    $options[] = array(
        'title'       => __( 'Privacy Policy Link Color', 'phlox' ),
        'id'          => 'footer_privacy_policy_link_color',
        'section'     => 'footer-section-footer',
        'type'        => 'color',
        'dependency'  => array(
            array(
        ...
        'style_callback' => function( $value = null ){
            if( ! $value ){
                $value = esc_attr( auxin_get_option( 'footer_privacy_policy_link_color' ) );
            }
            return $value ? ".aux-site-footer .aux-privacy-policy a { color: $value; }" : '';
        },
        'transport' => 'postMessage',
        'default'   => ''
    );
    ...
    $options[] = array(
        'title'       => __( 'Footer Background Gradient', 'phlox' ),
        'description' => __( 'Specifies the background color for footer', 'phlox' ),
