...
class Auxin_Theme_Screen_Help {
  ...
  function __construct() {
    ...
    public function display_support_info( $contextual_help, $screen_id, $screen ) {
        ...
        $help_content .= '<ul>';
        $help_content .= '<li>'. sprintf( __( 'A complete %s documentation %s, which updates regularly.', 'phlox' ), '<a target="_blank" href="'. esc_url( 'http://avt.li/doc-wizard-'. THEME_ID ) .'">', '</a>' ) . '</li>';
