...
class Auxin_Admin_Assets {
    ...
    public function enqueue_admin_scripts( $hook_suffix ) {
        ...
        wp_register_script('auxin_plugins'          , ADMIN_JS_URL . 'plugins.js',
            array( 'jquery', 'jquery-ui-slider', 'jquery-ui-sortable', 'base64', 'ace-editor'), $this->version
        );

        // Contains all general scripts
        wp_register_script('auxin_script'           , ADMIN_JS_URL . 'scripts.js' , array('jquery', 'auxin_plugins', 'media-upload'), $this->version );
