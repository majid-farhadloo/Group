    ...
    class Auxin {
        ...
        public function plugin_dependency_notice(){
            if( defined('AUXELS_VERSION') && defined('AUXELS_REQUIRED_VERSION') ){
                ...
                printf( __( 'Phlox theme cannot function properly due to following reason: "Phlox Core Elements" version %s is required. Current version is %s. Please update it. ', 'phlox'), AUXELS_REQUIRED_VERSION, AUXELS_VERSION );
                echo '</div>';
            }
        }
