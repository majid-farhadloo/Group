...
function auxin_the_post_thumbnail( $post_id = null, $width = null , $height = null, $crop = null , $quality = 100, $upscale = false ) {
    ...
    function auxin_get_the_responsive_attachment( $attachment_id = null, $args = array() ) {
        ...
        $defaults = array(
            ...
            'preload_preview' => true, // insert a low quality placeholder until lazyloading the main image
            'upscale'         => false,
            'size'            => 'large',
            'crop'            => null,
            'add_hw'          => true,
        ...
        $default_attr  = array(
            'src'              => $src,
            'class'            => "aux-attachment aux-featured-image attachment-$string_size aux-attachment-id-$attachment_id",
        ...
        if ( $preloadable ) {
            ...
            if( $preload_preview ){
                $attr['src'] = auxin_get_the_resized_attachment_src( $attachment_id, 40 , 40/$image_aspect_ratio, $crop, 100, false );
...
function auxin_filter_output( $args, $type, $align, $classname = null){
