...
;(function ( $, window, document, undefined ) {
    ...
    $.extend(Plugin.prototype, {
        ...
        _checkElementBoundaries: function( etp, wst, calc ) {
            ...
            var diff = this.$boundryTarget.offset().top + this.$boundryTarget.outerHeight(true) - (etp + wst + this.$element.outerHeight(true));
...
;(function ( $, window, document, undefined ) {
    ...
    $.extend( Plugin.prototype, {
        ...
        arrange: function( method, options ) {
            ...
            if ( this._currentFilter === io.filter && ( !this.settings.pagination || this._currentPage === io.page ) ) {
                return;
            } else {
        ...
        _updateHash: function() {
            ...
            var hashStr = '/' + this.settings.slug + '/' + this._sanitizeFilter(this._isotope.options.filter),
