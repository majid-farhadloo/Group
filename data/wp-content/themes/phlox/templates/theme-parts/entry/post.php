<?php global $post, $more, $aux_content_width; $more = 0; // to enable read more tag
    ...
    $post_vars   = auxin_get_post_format_media( $post, array(
        ...
        'image_sizes'  => array(
            array( 'min' => '',      'max' => '992px', 'width' => '80vw' ),
                        ...
                        <article <?php post_class(); ?> >
                            ...
                            <div class="entry-main">
                                ...
                                <div class="entry-info">
                                    ...
                                    <span class="meta-sep meta-author"><?php esc_html_e("by", 'phlox'); ?></span>
                                ...
                                <footer class="entry-meta">
                                    <div class="readmore">
                                        <a href="<?php the_permalink(); ?>" class="aux-read-more aux-outline aux-large"><?php echo esc_html( auxin_get_option( 'post_index_read_more_text' ) ); ?></a>
                                    </div>
                                </footer>
